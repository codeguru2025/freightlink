...
export const bids = pgTable("bids", {
  ...
  notes: text("notes"),
  reservedCommission: decimal("reserved_commission", { precision: 12, scale: 2 }).default("0"),
...
export const wallets = pgTable("wallets", {
  ...
  reservedBalance: decimal("reserved_balance", { precision: 12, scale: 2 }).notNull().default("0"),
  currency: varchar("currency").default("USD"),
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow(),
}, (table) => [
...
export const DOCUMENT_TYPES = ["id_document", "drivers_license", "vehicle_registration", "insurance", "proof_of_delivery", "invoice", "delivery_note", "shipment_note", "waybill", "signed_pod", "other", "application_form", "road_transporters_license", "cr14", "proof_of_residence", "key_personnel", "certificate_of_incorporation", "company_profile", "banking_details", "git_insurance", "vat_certificate", "tax_clearance", "vehicle_tracking"] as const;
